        ...
        <div className="bg-white border border-gray-100 rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.03)] overflow-hidden">
          ...
          <div className="p-10">
            <div className="mb-8">
              ...
              <p className="text-sm text-gray-500">Access your risk profile and insights.</p>
            </div>
            ...
            <form onSubmit={handleLogin} className="flex flex-col gap-5">
              ...
              <div className="mt-4">
                <button 
                  ...
                  disabled={loading}
                >
                  {loading ? <Loader2 className="animate-spin" size={20} /> : 'Login to Profile'}
          ...
          <div className="bg-gray-50 border-t border-gray-100 p-6 text-center">
            <p className="text-sm text-gray-500">
              New here? 
              <Link className="text-black font-bold hover:underline ml-2" to="/register">Create an Account</Link>
            </p>
          </div>
        </div>
        
        <p className="mt-8 text-center text-[10px] text-gray-400 font-medium">
          Securely encrypted via SHA-256. Institutional standard protocols.
        </p>
      </main>
    </div>
  );
